...
plot(points$DOC, points$PTL, main="NLA2012",
...
plot(points$DOC, points$NTL, main="NLA2012",
...
plot(points$NTL, points$PTL, main="NLA2012",
...
plot(points$DOC, points$NtoP, main="NLA2012",
