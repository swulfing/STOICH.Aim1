...
datapoints <-read.csv("Data/NLA/ChemData_NLAs2004.csv")
...
write.csv(cleaned_rows,"Data/MedianCalcs/NLAs2004_Medians.csv", row.names = FALSE)
...
##Mapping##
datapoints <-read.csv("Data/NLA/NLAs2004_points.csv")
