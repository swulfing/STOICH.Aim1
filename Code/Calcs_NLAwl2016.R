...
datapoints <-read.csv("Data/NLA/ChemData_NLAwl2016.csv")
...
write.csv(cleaned_rows,"Data/MedianCalcs/NLAwl2016_Medians.csv", row.names = FALSE)
...
##Mapping##
datapoints <- read.csv("Data/MedianCalcs/NLAwl2016_Medians.csv")
